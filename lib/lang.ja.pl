...
our %msg = (
    ...
    'tmpl' => 'スキン選択',
    'tmpl_exp' => 'PMAN3を表示するのに使うスキンを選択してください．スキンはtmpl下にディレクトリを作って複数置くことができます．いくつかのサンプルを<a href="http://se.is.kit.ac.jp/~o-mizuno/pman3download.html">PMAN3のサイトからダウンロード</a>できます．',
